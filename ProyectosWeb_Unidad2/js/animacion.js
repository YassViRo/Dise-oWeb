		...
		var productos = [
			{
				...
				name : 'Mochila ',
				price : 299.00,
				desc : 'Mochila in capsule the same coin as you see in this picture. We only Ship to the Perú, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 4
			},
			{
				id : 2,
				...
				img : 'img/Reloj.png',
				price : 199.00,
				desc : 'Reloj in capsule the same coin as you see in this picture. We only Ship to the Perú, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 2
			},
			{
				id : 3,
				name : 'Zapatillas',
				img : 'img/Zapatillas.png',
				price : 99.00,
				desc : 'Zapatillas in capsule the same coin as you see in this picture. We only Ship to the Perú, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 1
			}
		],
